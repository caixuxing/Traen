...
namespace Trasen.PaperFree.Application.MedicalRecord.Query.Recall
{
    ...
    /// 召回申请管理列表查询参数Qry
    /// </summary>
    public record FindRecallApplyPageListQry : IRequest<PageData<List<RecallApplyPageDto>>>
    {
        /// <summary>
        /// 开始时间
        /// </summary>
        ...
        /// <returns></returns>
        public FindRecallApplyPageListQry SetPageParam(int pageIndex, int pageSize)
        {
    ...
    /// 验证规则
    /// </summary>
    public class FindRecallApplyPageListValidate : AbstractValidator<FindRecallApplyPageListQry>
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        public FindRecallApplyPageListValidate()
        {
