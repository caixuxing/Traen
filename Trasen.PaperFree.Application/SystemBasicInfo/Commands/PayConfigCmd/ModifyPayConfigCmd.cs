...
{
    public class ModifyPayConfigCmd : IRequest<bool>
    {
        /// <summary>
        /// 服务提供者
        /// </summary>
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public ModifyPayConfigCmd SetId(string id)
        {
            Id = id;
            return this;
        }
        ...
        /// 验证规则
        /// </summary>
        public class ModifyPayConfigCmdValidate : AbstractValidator<ModifyPayConfigCmd>
        {
            /// <summary>
            /// 构造函数
            /// </summary>
            public ModifyPayConfigCmdValidate()
            {
