...
namespace Trasen.PaperFree.Infrastructure.Migrations
{
    ...
    [Migration("20240411022426__up_addOtupatientEmergency")]
    partial class _up_addOtupatientEmergency
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Trasen.PaperFree.Domain.MedicalRecord.Entity.MedicalRecor", b =>
                {
                    b.Property<string>("Id")
                        .HasMaxLength(50)
                        .HasColumnType("NVARCHAR2(50)")
                    ...
                    b.Property<string>("MedicalRecorNo")
                        .IsRequired()
                        .HasColumnType("NVARCHAR2(2000)");

                    b.Property<int>("MedicalRecorStatus")
                        .HasColumnType("NUMBER(10)");

                    b.Property<string>("MedicalRecorTitle")
                        .IsRequired()
                        .HasColumnType("NVARCHAR2(2000)");
                    ...
                    b.ToTable("MedicalRecor", (string)null);
            ...
            modelBuilder.Entity("Trasen.PaperFree.Domain.ProcessRecord.Entity.ProcessNode", b =>
                {
                    ...
                    b.Property<string>("RejectNodeId")
                        .HasMaxLength(50)
                        .HasColumnType("NVARCHAR2(50)")
                        .HasColumnName("REJECT_NODE_ID")
                        .HasComment("驳回节点");
            ...
            modelBuilder.Entity("Trasen.PaperFree.Domain.SystemBasicData.Entity.BaseWatermark", b =>
                {
                    ...
                    b.Property<int>("Xstation")
                        .HasMaxLength(10)
                        .HasColumnType("NUMBER(10)")
                        .HasColumnName("XSTATION")
                        .HasComment("x坐标");

                    b.Property<int>("Ystation")
                        .HasMaxLength(10)
                        .HasColumnType("NUMBER(10)")
